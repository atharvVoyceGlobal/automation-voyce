            ...
            if token:
                ...
                def bulk_update_provider_specializations():
                    ...
                    if response.status_code == 200:
                        ...
                        print(f"Failed to update specializations: {response.status_code} - {response.text}")
                ...
                def reset_provider_password():
                    ...
                    if response.status_code == 204:
                        ...
                        print(f"Bad Request: The request for provider {provider_id} is invalid.")
                    elif response.status_code == 401:
                        print("Unauthorized: Check your authorization token.")
                    elif response.status_code == 404:
                        print(f"Not Found: Provider with ID {provider_id} does not exist.")
                    else:
                ...
                def change_provider_password():
                    ...
                    BASE_URL = "https://cloudbreak-admin-api.dev.cloudbreak.us"
                    CHANGE_PASSWORD_ENDPOINT = f"/v1/providers/{provider_id}/change-password"
                    #
                    payload = {
                    ...
                    print(f"Changing password for provider with ID: {provider_id}...")
                    print("Request URL:", change_password_url)
                    ...
                    #
                    if response.status_code == 204:
                        print(f"Password change successful for provider {provider_id}.")
                    elif response.status_code == 400:
                        print(f"Bad Request: The request for provider {provider_id} is invalid.")
                    elif response.status_code == 401:
                        print("Unauthorized: Check your authorization token.")
                        ...
                        print(
                            f"Server Error: Internal server error occurred while processing the request for provider {provider_id}.")
                    else:
                        print(f"Unexpected error: {response.status_code} - {response.text}")
                ...
                def create_skill():
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            print("Bad request. Check your payload.", response.text)
                        elif response.status_code == 401:
                            print("Unauthorized. Check your authorization token.", response.text)
                        elif response.status_code == 500:
                            print("Internal server error. Try again later.", response.text)
                        else:
                ...
                def update_skill():
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            print("Skill not found. Check the skill ID.", response.text)
                        elif response.status_code == 500:
                            print("Internal server error. Try again later.", response.text)
                        else:
                            print(f"Unexpected response: {response.status_code}", response.text)
                ...
                def update_admin():
                    ...
                    print(f"Updating admin with ID: {self.BASE_URL}...")
                    ...
                    if response.status_code == 200:
                        ...
                        print("Admin not found. Check the admin ID.")
                        print("Details:", response.text)
                    else:
                ...
                def fetch_agents(page=1, limit=20, search=None, order_by="lastName",
                                 order_type="desc", roles=None, statuses=None, partner_id=None, vendor_id=None):
                    ...
                    print("Fetching agents with filters:", params)
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            print("Error 400: Bad Request - Invalid filters provided.")
                        elif response.status_code == 401:
                            print("Error 401: Unauthorized - Check your access token.")
                        else:
                            print(f"Unexpected error: {response.status_code}, {response.text}")
                ...
                def create_agent(page=1, limit=1, search=None, order_by="lastName", order_type="desc", partner_id=None):
                    ...
                    if not agents or "results" not in agents or len(agents["results"]) == 0:
                        print("No agents found to copy data from.")
                        return None

                    source_agent = agents["results"][0]
                    print("Source agent data", agents)
                    ...
                    try:
                        ...
                        if response.status_code == 201:
                            ...
                            updated_data = {
                                ...
                                "status": "Active",
                                "interpreterLanguageIds": [str(lang) for lang in
                                                           created_agent.get("interpreterLanguages", [])],
                            }
                            ...
                            if update_response.status_code == 200:
                                ...
                                print(
                                    f"Failed to update agent. Status code: {update_response.status_code}, Response: {update_response.text}")
                                return created_agent
                        elif response.status_code == 400:
                            print("Error 400: Bad Request - Invalid input provided.")
                        elif response.status_code == 401:
                            print("Error 401: Unauthorized - Check your access token.")
                        elif response.status_code == 404:
                            print("Error 404: Partner not found.")
                        elif response.status_code == 409:
                            print("Error 409: Conflict - The agent already exists.")
                        else:
                            print(f"Unexpected error: {response.status_code}, {response.text}")
                    except requests.RequestException as e:
                        print(f"Request failed: {e}")
                ...
                def reset_agent_presence():
                    ...
                    if response.status_code == 204:
                        ...
                        print("Bad request: Check the agent ID or request format.")
                    elif response.status_code == 401:
                        print("Unauthorized: Check your token or permissions.")
                    elif response.status_code == 404:
                        print("Agent not found: Verify the agent ID.")
                    else:
                        print(f"Unexpected error: {response.status_code} - {response.text}")
                ...
                def change_agent_password():
                    ...
                    try:
                        ...
                        if response.status_code == 204:
                            ...
                            print("Bad request: Check the request format or password policy.")
                        elif response.status_code == 401:
                            print("Unauthorized: Check your token or permissions.")
                        elif response.status_code == 500:
                            print("Internal server error: Contact support.")
                        else:
                            print(f"Unexpected response: {response.status_code} - {response.text}")
                    except Exception as e:
                ...
                def get_scripts():
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            ...
                            print("Bad request: Check the request format or query parameters.")
                        elif response.status_code == 401:
                            print("Unauthorized: Check your token or permissions.")
                        elif response.status_code == 500:
                            print("Internal server error: Contact support.")
                    ...
                    try:
                        ...
                        if response.status_code == 200:
                            try:
                                ...
                                print("Script updated, but response is not in JSON format.")

                        elif response.status_code == 400:
                            print("Bad Request: Check your payload or request parameters.")
                        elif response.status_code == 401:
                            print("Unauthorized: Check your authorization token.")
                        elif response.status_code == 404:
                            print(f"Not Found: Script with ID {SCRIPT_PG_ID} does not exist.")
                        elif response.status_code == 500:
                            print("Internal Server Error: The server encountered an unexpected condition.")
                        else:
                            print(
                                f"Unexpected response: Status Code = {response.status_code}, Response Text = {response.text}")
                ...
                def test_delete_script():
                    ...
                    if response.status_code == 200:
                        ...
                        print("Not found: Script with ID does not exist.")
                    else:
                        print(
                            f"Unexpected response: Status Code = {response.status_code}, Response Text = {response.text}")
                ...
                def test_update_queue():
                    ...
                    payload = {
                        ...
                        "timeoutInSeconds": 45,
                        "languageId": "aAX2i0000008PPqGAM",
                        "channel": "VIDEO",
                        "timeoutQueueId": "aAi2i000000ChBhCAK",
                        "timeoutPhoneNumber": "9876543210",
                        "partnerId": "aAH2i000000CezPGAS",
                        "microCallCenter": False
                    }
